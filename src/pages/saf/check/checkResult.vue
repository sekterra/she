  ...
  methods: {
    init () {
      ...
      this.gridOptions.header = [
        { text: '진행단계', name: 'checkStepNm', width: '150px', },
        { text: '점검종류', name: 'safCheckKindNm', width: '130px', },
        { text: '점검예정일', name: 'checkSchYmd', width: '150px', align: 'center' },
        { text: '점검일', name: 'checkYmd', width: '150px', align: 'center' },
        { text: '점검명', name: 'checkTitle', width: '180px', type: 'link' },
        { text: '주관부서', name: 'deptNm', width: '150px', },
        { text: '대상부서', name: 'tgtDeptNm', width: '150px', },
    ...
    showCheckResultPopup (data) {
      ...
      this.popupOptions.title = '안전점검결과 등록';
