...
export default {
  ...
  name: 'y-work-mesaure-result-chemical',
  props: {
  },
  data: () => ({
    searchParam: {
  ...
  methods: {
    init () {
      // Url Setting
      this.searchUrl = selectConfig.rsa.workMeasureResultChemical.list.url;   
      // 그리드 헤더 설정
      this.gridOptions.header = [
        ...
        { text: 'CAS NO.', name: 'casNo', width: '150px', },
      ...
      // this.getList(); // 작업환경측정결과 화학적인자 목록 조회 
