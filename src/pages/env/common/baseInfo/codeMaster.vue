...
export default {
  ...
  methods: {
    init () {
      ...
      this.insertUrl = transactionConfig.env.com.baseInfo.codeMaster.insert.url;
      this.editUrl = transactionConfig.env.com.baseInfo.codeMaster.edit.url;
      this.searchUrl = selectConfig.env.com.baseInfo.codeMaster.list.url;
      this.detailUrl = selectConfig.env.com.baseInfo.codeMaster.get.url;
    ...
    getCodeGroup () {
      if (this.codeMaster.codeGroupCd !== '') {
        this.$http.url = this.$format(selectConfig.env.com.baseInfo.codeGroup.get.url, this.codeMaster.codeGroupCd);
        this.$http.type = 'get';
        this.$http.request((_result) => {
    ...
    getCodeGroupCdItems () {
      this.$http.url = selectConfig.env.com.baseInfo.codeGroup.list.url;
      this.$http.type = 'get';
      this.$http.request((_result) => {
