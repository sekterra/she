...
export default {
  ...
  methods: {
    init () {
      ...
      this.insertUrl = transactionConfig.env.water.baseInfo.codeMaster.insert.url;
      this.editUrl = transactionConfig.env.water.baseInfo.codeMaster.edit.url;
      this.searchUrl = selectConfig.env.water.baseInfo.codeMaster.list.url;
      this.detailUrl = selectConfig.env.water.baseInfo.codeMaster.get.url;
    ...
    getCodeGroup () {
      if (this.codeMaster.codeGroupCd !== '') {
        this.$http.url = this.$format(selectConfig.env.water.baseInfo.codeGroup.get.url, this.codeMaster.codeGroupCd);
        this.$http.type = 'get';
        this.$http.request((_result) => {
    ...
    getCodeGroupCdItems () {
      this.$http.url = selectConfig.env.water.baseInfo.codeGroup.list.url;
      this.$http.type = 'get';
      this.$http.request((_result) => {
