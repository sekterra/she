  ...
  methods: {
    ...
    init () {
      ...
      this.gridOptions.header = [
        { text: '공급수 분류명', name: 'ewtrSuplClassNm', width: '250px', align: 'left' },
        { text: '공급수명', name: 'ewtrSuplNm', width: '250px', align: 'left' },
