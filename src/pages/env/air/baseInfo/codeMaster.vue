  ...
  <b-container fluid>
    ...
    <b-row class="mt-3">
      <b-col sm="12">
        <b-row>
          <b-col sm="12">
            <y-label label="대기코드 등록" icon="user-edit" color-class="cutstom-title-color" />
          </b-col>
        </b-row>
        <b-card>          
          <b-row> 
  ...
  methods: {
    init () {
      ...
      this.gridOptions.header = [
        ...
        { text: '비고', name: 'remarks', width: '500px' },        
      ...
      this.insertUrl = transactionConfig.env.air.baseInfo.codeMaster.insert.url;
      this.editUrl = transactionConfig.env.air.baseInfo.codeMaster.edit.url;
      this.searchUrl = selectConfig.env.air.baseInfo.codeMaster.list.url;
      this.detailUrl = selectConfig.env.air.baseInfo.codeMaster.get.url;
    ...
    getCodeGroup () {
      if (this.codeMaster.codeGroupCd !== '') {
        this.$http.url = this.$format(selectConfig.env.air.baseInfo.codeGroup.get.url, this.codeMaster.codeGroupCd);
        this.$http.type = 'get';
        this.$http.request((_result) => {
    ...
    getCodeGroupCdItems () {
      this.$http.url = selectConfig.env.air.baseInfo.codeGroup.list.url;
      this.$http.type = 'get';
      this.$http.request((_result) => {
